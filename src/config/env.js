...
const envSchema = z.object({
  ...
  META_CAMPAIGN_TEMPLATE_NAME: z.string().default(''),
  META_CAMPAIGN_TEMPLATE_LANGUAGE: z.string().default('es'),
  META_CAMPAIGN_TEMPLATE_HEADER_IMAGE_URL: z.string().default(''),
  MEDIA_STORAGE_DIR: z.string().default('uploads/message-media'),
  ...
  SPA_FAQ_EXTRA: z.string().default('Ofrecemos tratamientos de bienestar y estetica con atencion personalizada para cada cliente.'),
  SPA_INSTAGRAM: z.string().default('Instagram oficial del centro'),
...
const env = {
  ...
  metaCampaignTemplateName: parsedEnv.data.META_CAMPAIGN_TEMPLATE_NAME || null,
  metaCampaignTemplateLanguage: parsedEnv.data.META_CAMPAIGN_TEMPLATE_LANGUAGE || 'es',
  metaCampaignTemplateHeaderImageUrl: parsedEnv.data.META_CAMPAIGN_TEMPLATE_HEADER_IMAGE_URL || null,
  mediaStorageDir: parsedEnv.data.MEDIA_STORAGE_DIR,
